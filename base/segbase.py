...
#from ..nn import JPU
from net.resnetv1b import resnet50_v1s, resnet101_v1s, resnet152_v1s
...
class SegBaseModel(nn.Module):
    ...
    def __init__(self, nclass, aux=False, backbone='resnet50', jpu=False, pretrained_base=True, **kwargs):
